        ...
        <div className="w-full" id="roti">
            <div className="max-w-[1000px] mt-28 mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-5 rounded-sm">
                    ...
                    <div className="relative">
                        <div className="absolute inset-0 z-10 bg-[#d8d9d8] text-center flex flex-col items-center justify-center opacity-0 hover:opacity-100 bg-opacity-55 duration-200 transition-all ease-out cursor-pointer">
